...
pro = ts.pro_api()
#查询当前所有正常上市交易的股票列表
stocks = pro.stock_basic(exchange='', list_status='L', fields='ts_code,ts_code,name,area,industry,list_date')
...
for index, row in stocks.iterrows():
    ...
    his_data = pro.daily(ts_code=ts_code, start_date='20130322', end_date='20190414') #一次性获取全部数据
    if his_data is None:
        continue
    ...
    df_tmp[['sequence','amount']] = his_data[['trade_date','open']]
    df_tmp['scene'] = ts_code + "_" + industry
